...
<div class="nav-cart">
	<a 	href="${fn:escapeXml(cartUrl)}"
		...
		<ycommerce:testId code="miniCart_items_label">
			...
			<div class="mini-cart-count js-mini-cart-count"><span class="nav-items-total">${totalItems lt 100 ? fn:escapeXml(totalItems) : "99+"}<span class="items-responsive hidden-xs">&nbsp;<spring:theme code="basket.items"/></span></span></div>
		</ycommerce:testId>
