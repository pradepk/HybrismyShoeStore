...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myshoestorestorefront/electronics/en",
						"https://electronics.local:9002/myshoestorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myshoestorestorefront/electronics/en",
						"https://electronics.local:9002/myshoestorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myshoestorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/myshoestorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myshoestorestorefront/electronics/en",
						"https://electronics.local:9002/myshoestorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myshoestorestorefront",
						"https://electronics.local:9002/myshoestorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myshoestorestorefront",
						"https://electronics.local:9002/myshoestorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/myshoestorestorefront/electronics/en",
						"https://electronics.local:9002/myshoestorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
