 ...
 */
package de.hybris.myshoestore.test.setup;
...
import de.hybris.myshoestore.test.constants.MyshoestoreTestConstants;
import de.hybris.myshoestore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MyshoestoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/myshoestoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/myshoestoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/myshoestoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/myshoestoretest/import/csquotes.impex");
		}
	}
}
