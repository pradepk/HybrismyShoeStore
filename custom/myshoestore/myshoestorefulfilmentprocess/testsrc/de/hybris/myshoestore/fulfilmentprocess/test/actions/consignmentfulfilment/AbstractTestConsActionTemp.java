 ...
 */
package de.hybris.myshoestore.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, MyshoestoreFulfilmentProcessConstants.PARENT_PROCESS);
