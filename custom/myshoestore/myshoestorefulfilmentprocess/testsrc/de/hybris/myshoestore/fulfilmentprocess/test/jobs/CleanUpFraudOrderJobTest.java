 ...
 */
package de.hybris.myshoestore.fulfilmentprocess.test.jobs;
...
import de.hybris.myshoestore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MyshoestoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
