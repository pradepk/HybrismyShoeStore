...
/**
 * This is the extension manager of the occaddon extension.
 */
public class OccaddonManager extends GeneratedOccaddonManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(OccaddonManager.class.getName());
	 ...
	 */
	public OccaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OccaddonManager called.");
		}
	}
	 ...
	 */
	public static OccaddonManager getInstance()
	{
		return (OccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(OccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
