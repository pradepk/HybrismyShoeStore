...
public class DefaultNewproductcronjobService implements NewproductcronjobService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultNewproductcronjobService.class);
	...
	{
		return DefaultNewproductcronjobService.class.getResourceAsStream("/newproductcronjob/sap-hybris-platform.png");
	}
