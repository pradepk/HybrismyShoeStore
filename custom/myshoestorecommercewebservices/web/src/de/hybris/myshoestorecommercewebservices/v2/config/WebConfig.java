 ...
 */
package de.hybris.myshoestorecommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import de.hybris.myshoestorecommercewebservices.constants.YcommercewebservicesConstants;
import de.hybris.myshoestorecommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "myshoestorecommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "myshoestorecommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "myshoestorecommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "myshoestorecommercewebservices.v2.description";
	private static final String TITLE = "myshoestorecommercewebservices.v2.title";
	private static final String VERSION = "myshoestorecommercewebservices.v2.version";
	private static final String LICENSE = "myshoestorecommercewebservices.v2.license";
	private static final String LICENSE_URL = "myshoestorecommercewebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "myshoestorecommercewebservices.content.negotiation.legacy";
