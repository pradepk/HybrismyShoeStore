 ...
 */
package de.hybris.myshoestorecommercewebservices.v1.controller;

import static de.hybris.myshoestorecommercewebservices.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
import de.hybris.myshoestorecommercewebservices.formatters.WsDateFormatter;
import de.hybris.myshoestorecommercewebservices.product.data.ProductDataList;
import de.hybris.myshoestorecommercewebservices.product.data.SuggestionDataList;
import de.hybris.myshoestorecommercewebservices.queues.data.ProductExpressUpdateElementData;
import de.hybris.myshoestorecommercewebservices.queues.data.ProductExpressUpdateElementDataList;
import de.hybris.myshoestorecommercewebservices.queues.impl.ProductExpressUpdateQueue;
import de.hybris.myshoestorecommercewebservices.stock.CommerceStockFacade;
import de.hybris.myshoestorecommercewebservices.util.ws.SearchQueryCodec;
import de.hybris.myshoestorecommercewebservices.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link de.hybris.myshoestorecommercewebservices.populator.HttpRequestReviewDataPopulator} to populate review data
