 ...
 */
package de.hybris.evbikestore.jalo;
...
import de.hybris.evbikestore.constants.EvbikestoreConstants;
 ...
 */
public class EvbikestoreManager extends GeneratedEvbikestoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(EvbikestoreManager.class.getName());
	 ...
	 */
	public static EvbikestoreManager getInstance()
	{
		return (EvbikestoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(EvbikestoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EvbikestoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EvbikestoreManager called.");
		}
	}
